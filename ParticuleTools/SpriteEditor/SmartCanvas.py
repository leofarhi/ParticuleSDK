...
class CanvasDrawer:
    ...
    def text(self, text, position, font: CanvasFont, color="black", stroke_width=0, stroke_fill="black"):
        self._draw.text(position, text, fill=color, font=font.get_pil_font(), stroke_width=stroke_width, stroke_fill=stroke_fill)
...
class SmartCanvas(tk.Canvas):
    def __init__(self, master, callback=None, bg_color="white", **kwargs):
        ...
        self._create_surface(self.winfo_width(), self.winfo_height())
